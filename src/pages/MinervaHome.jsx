...
const TOOLS = [
  ...
  { to: '/sleep', title: 'Sleep', blurb: 'Track your sleep patterns and quality.' },
  { to: '/achievements', title: 'Achievements', blurb: 'Earn badges for your accomplishments.' },
  { to: '/export', title: 'Export', blurb: 'Download all your data as a ZIP file.' },
